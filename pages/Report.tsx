...
export const Report: React.FC<ReportProps> = ({ isBetSlipOpen, onOpenGlobalSlip }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-24 relative">
      ...
      {/* CHARTS TABS */}
      <div className="bg-cardbg border border-neutral-800 p-5 rounded-xl">
         <h3 className="text-xs font-bold text-neutral-400 uppercase mb-4 flex items-center gap-2">
             <TrendingUp size={14} /> Trend Profitto (Bankroll)
         </h3>
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    <defs>
                        <linearGradient id="colorProfit" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor={stats.netProfit >= 0 ? "#22c55e" : "#ef4444"} stopOpacity={0.3}/>
                            <stop offset="95%" stopColor={stats.netProfit >= 0 ? "#22c55e" : "#ef4444"} stopOpacity={0}/>
                        </linearGradient>
                    </defs>
                    ...
                    <Tooltip 
                        contentStyle={{ backgroundColor: '#171717', borderColor: '#333', color: '#fff', fontSize: '12px' }}
                        itemStyle={{ color: '#fff' }}
                        labelStyle={{ display: 'none' }}
                        formatter={(value: number) => [`${value.toFixed(2)}€`, 'Profitto']}
                    />
                    <Area 
                        type="monotone" 
                        dataKey="value" 
